...
| [aws_vpc_endpoint_route_table_association.protected_s3](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_endpoint_route_table_association) | resource |
...
| <a name="input_private_subnet_cidrs"></a> [private\_subnet\_cidrs](#input\_private\_subnet\_cidrs) | (Optional) List of Private Subnet CIDRs. Used when enable\_dynamic\_subnets is disabled | `map(list(string))` | `{}` | no |
| <a name="input_protected_egress_acl_rules"></a> [protected\_egress\_acl\_rules](#input\_protected\_egress\_acl\_rules) | Protected subnets outbound network ACLs | `list(map(string))` | <pre>[<br>  {<br>    "cidr_block": "0.0.0.0/0",<br>    "from_port": 0,<br>    "protocol": "-1",<br>    "rule_action": "allow",<br>    "rule_number": 100,<br>    "to_port": 0<br>  }<br>]</pre> | no |
| <a name="input_protected_ingress_acl_rules"></a> [protected\_ingress\_acl\_rules](#input\_protected\_ingress\_acl\_rules) | Protected subnets inbound network ACLs | `list(map(string))` | `[]` | no |
| <a name="input_protected_subnet_cidrs"></a> [protected\_subnet\_cidrs](#input\_protected\_subnet\_cidrs) | (Optional) List of Protected Subnet CIDRs. Used when enable\_dynamic\_subnets is disabled | `map(list(string))` | `{}` | no |
...
| <a name="input_public_subnet_cidrs"></a> [public\_subnet\_cidrs](#input\_public\_subnet\_cidrs) | (Optional) List of Public Subnet CIDRs. Used when enable\_dynamic\_subnets is disabled | `map(list(string))` | `{}` | no |
...
| <a name="output_private_route_table_id"></a> [private\_route\_table\_id](#output\_private\_route\_table\_id) | The ID of the Private routing table. |
| <a name="output_private_route_table_owner_id"></a> [private\_route\_table\_owner\_id](#output\_private\_route\_table\_owner\_id) | The ID of the AWS account that owns the Private route table. |
